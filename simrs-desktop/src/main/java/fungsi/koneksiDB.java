...
public class koneksiDB {
    ...
    private static void initDataSource() throws Exception {
        ...
        String host = EnkripsiAES.decrypt(prop.getProperty("HOST"));
        String port = EnkripsiAES.decrypt(prop.getProperty("PORT"));
        String database = EnkripsiAES.decrypt(prop.getProperty("DATABASE"));
        ...
        String user = EnkripsiAES.decrypt(prop.getProperty("USER"));
        String pass = "secret";
//        String pass = EnkripsiAES.decrypt(prop.getProperty("PAS"));
